...
-- Nightly ANALYZE (3:05 AM)
-- NOTE: pg_cron runs jobs in the database where you schedule them.
-- You want this in your app DB, not postgres template.
...
-- Weekly bloat snapshot using pgstattuple_approx (Sun 03:10)
...
SELECT cron.schedule('partman-maint', '0 * * * *',
